...
$$\[\frac{2}{\pi},\frac{-4}{\pi},\frac{6}{\pi},\frac{-8}{\pi},\frac{10}{\pi}\]$$

and the transformed frequency domain representation also as a vector

$$\[\frac{2}{\pi},\frac{-4}{\pi},\frac{6}{\pi},0,0\]$$

then this filter can thought of as a dot product with the vector $\[1,1,1,0,0\]$

$$
\[\frac{2}{\pi},\frac{-4}{\pi},\frac{6}{\pi},\frac{-8}{\pi},\frac{10}{\pi}\] \cdot \[1,1,1,0,0\] = \[\frac{2}{\pi},\frac{-4}{\pi},\frac{6}{\pi},0,0\]
$$
