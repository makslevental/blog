...
&=&  \sum _{n=1}^{\infty }U_ne^{i2\pi n t}\\
\end{eqnarray*}
$$
...
$$
\begin{eqnarray*}
\int_0^1 s(t)e^{-i2\pi m t} dt &=& \int_0^1 \sum _{n=1}^{\infty }U_ne^{i2\pi n t}e^{-i2\pi m t} dt\\
&=& \sum _{n=1}^{\infty }U_n\int_0^1 e^{i2\pi (n-m) t} dt\\
&=&\begin{cases}
            U_n (1+0i) &{\text{if }}n = m\\
            U_n (0+0i) &{\text{if }} n \neq m
        \end{cases}
...
$$
\begin{eqnarray*}
s(t) &=&  \sum _{n=1}^{\infty }U_ne^{i2\pi n t}\\
